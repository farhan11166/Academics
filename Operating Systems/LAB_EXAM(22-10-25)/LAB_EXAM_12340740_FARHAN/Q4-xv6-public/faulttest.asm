...
_faulttest:     file format elf32-i386
...
printf(1,"Page faults : %d\n",getpagefaults());
  11:	e8 45 03 00 00       	call   35b <getpagefaults>
...
int size=pages*4096;
char *mem= sbrk(size);
  26:	c7 04 24 00 40 00 00 	movl   $0x4000,(%esp)
  2d:	e8 09 03 00 00       	call   33b <sbrk>
for(int i=0;i<size;i++)
  32:	83 c4 10             	add    $0x10,%esp
  35:	8d 90 00 40 00 00    	lea    0x4000(%eax),%edx
  3b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
{mem[i]=1;}
  40:	c6 00 01             	movb   $0x1,(%eax)
for(int i=0;i<size;i++)
  43:	83 c0 02             	add    $0x2,%eax
{mem[i]=1;}
  46:	c6 40 ff 01          	movb   $0x1,-0x1(%eax)
for(int i=0;i<size;i++)
  4a:	39 d0                	cmp    %edx,%eax
  4c:	75 f2                	jne    40 <main+0x40>
printf(1,"Page faults afte : %d\n",getpagefaults() );
  4e:	e8 08 03 00 00       	call   35b <getpagefaults>
  53:	83 ec 04             	sub    $0x4,%esp
  56:	50                   	push   %eax
  57:	68 2a 07 00 00       	push   $0x72a
  5c:	6a 01                	push   $0x1
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 41 07 00 00       	mov    $0x741,%ebx
 ...
 5a1:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 3c 0a 00 00    	cmp    0xa3c,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 40 0a 00 00       	mov    $0xa40,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 700:	00 00 00 
    if(p->s.size >= nunits){
