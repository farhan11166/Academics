...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 20 13 00 00       	push   $0x1320
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 7a 12 00 00       	push   $0x127a
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 14 13 00 00       	push   $0x1314
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 7a 12 00 00       	push   $0x127a
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 86 12 00 00       	push   $0x1286
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2d2:	68 a6 12 00 00       	push   $0x12a6
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 c8 12 00 00       	push   $0x12c8
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 ab 12 00 00       	push   $0x12ab
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 cb 12 00 00       	push   $0x12cb
     7a4:	56                   	push   %esi
     7a5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 e2 12 00 00       	push   $0x12e2
     80b:	56                   	push   %esi
     80c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 d4 12 00 00       	push   $0x12d4
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 cd 12 00 00       	push   $0x12cd
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 e7 12 00 00       	push   $0x12e7
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 e9 12 00 00       	push   $0x12e9
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 e5 12 00 00       	push   $0x12e5
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 cb 12 00 00       	push   $0x12cb
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 07 13 00 00       	push   $0x1307
  cmd = parseline(ps, es);
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b73:	68 95 12 00 00       	push   $0x1295
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 09 13 00 00       	push   $0x1309
     ba5:	6a 02                	push   $0x2
     ba7:	e8 b4 03 00 00       	call   f60 <printf>
    panic("syntax");
     bac:	c7 04 24 cd 12 00 00 	movl   $0x12cd,(%esp)
     ...
     ec8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efb:	0f b6 92 c0 13 00 00 	movzbl 0x13c0(%edx),%edx
     ...
     f69:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fd4:	ff 24 85 68 13 00 00 	jmp    *0x1368(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    10e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10e5:	bb 2e 13 00 00       	mov    $0x132e,%ebx
