...
int main(void){
 ...
 for(int i=0;i<strlen(stringArray);i++){
  7f:	83 c3 01             	add    $0x1,%ebx
    printf(1,"%s",stringArray[i]);
  82:	50                   	push   %eax
  83:	68 64 07 00 00       	push   $0x764
  88:	6a 01                	push   $0x1
  8a:	e8 c1 03 00 00       	call   450 <printf>
 for(int i=0;i<strlen(stringArray);i++){
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 67 07 00 00       	mov    $0x767,%ebx
 ...
 5e1:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 6c 0a 00 00       	mov    %eax,0xa6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bb:	3b 05 6c 0a 00 00    	cmp    0xa6c,%eax
 ...
 6de:	e8 fd fe ff ff       	call   5e0 <free>
  return freep;
 6e3:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 70 0a 00 00       	mov    $0xa70,%eax
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 736:	0a 00 00 
    base.s.size = 0;
 739:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 740:	00 00 00 
    if(p->s.size >= nunits){
