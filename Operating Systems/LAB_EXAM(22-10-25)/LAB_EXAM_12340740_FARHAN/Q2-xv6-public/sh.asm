...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 10 13 00 00       	push   $0x1310
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 6a 12 00 00       	push   $0x126a
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 04 13 00 00       	push   $0x1304
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 6a 12 00 00       	push   $0x126a
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 76 12 00 00       	push   $0x1276
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2d2:	68 96 12 00 00       	push   $0x1296
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 b8 12 00 00       	push   $0x12b8
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 9b 12 00 00       	push   $0x129b
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 bb 12 00 00       	push   $0x12bb
     7a4:	56                   	push   %esi
     7a5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 d2 12 00 00       	push   $0x12d2
     80b:	56                   	push   %esi
     80c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 c4 12 00 00       	push   $0x12c4
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 bd 12 00 00       	push   $0x12bd
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 d7 12 00 00       	push   $0x12d7
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 d9 12 00 00       	push   $0x12d9
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 d5 12 00 00       	push   $0x12d5
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 bb 12 00 00       	push   $0x12bb
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 f7 12 00 00       	push   $0x12f7
  cmd = parseline(ps, es);
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b73:	68 85 12 00 00       	push   $0x1285
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 f9 12 00 00       	push   $0x12f9
     ba5:	6a 02                	push   $0x2
     ba7:	e8 a4 03 00 00       	call   f50 <printf>
    panic("syntax");
     bac:	c7 04 24 bd 12 00 00 	movl   $0x12bd,(%esp)
     ...
     f59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    10d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10d5:	bb 1e 13 00 00       	mov    $0x131e,%ebx
