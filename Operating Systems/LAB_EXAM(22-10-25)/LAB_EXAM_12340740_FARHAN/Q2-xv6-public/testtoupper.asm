...
int main(void){
 ...
 char stringArray[32]="Write Your FUll Name Here";
  15:	c7 45 d8 57 72 69 74 	movl   $0x74697257,-0x28(%ebp)
 printf(1,"Before: %s\n",stringArray);
  1c:	53                   	push   %ebx
  1d:	68 18 07 00 00       	push   $0x718
  22:	6a 01                	push   $0x1
 char stringArray[32]="Write Your FUll Name Here";
  24:	c7 45 dc 65 20 59 6f 	movl   $0x6f592065,-0x24(%ebp)
  2b:	c7 45 e0 75 72 20 46 	movl   $0x46207275,-0x20(%ebp)
  32:	c7 45 e4 55 6c 6c 20 	movl   $0x206c6c55,-0x1c(%ebp)
  39:	c7 45 e8 4e 61 6d 65 	movl   $0x656d614e,-0x18(%ebp)
  40:	c7 45 ec 20 48 65 72 	movl   $0x72654820,-0x14(%ebp)
  47:	c7 45 f0 65 00 00 00 	movl   $0x65,-0x10(%ebp)
