...
_testgetyear:     file format elf32-i386
...
printf(1, "Current year from kernel: %d\n", getyear());
  11:	e8 fd 02 00 00       	call   313 <getyear>
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 550:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 555:	bb f6 06 00 00       	mov    $0x6f6,%ebx
...
free(void *ap)
{
 ...
 561:	a1 f4 09 00 00       	mov    0x9f4,%eax
{
 ...
 59f:	5b                   	pop    %ebx
  freep = p;
 5a0:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
 5a7:	5d                   	pop    %ebp
 ...
 5b6:	72 ce                	jb     586 <free+0x26>
{
 ...
 5d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5da:	a3 f4 09 00 00       	mov    %eax,0x9f4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63b:	3b 05 f4 09 00 00    	cmp    0x9f4,%eax
 ...
 65e:	e8 fd fe ff ff       	call   560 <free>
  return freep;
 663:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
 ...
 68c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 68f:	89 15 f4 09 00 00    	mov    %edx,0x9f4
}
 ...
 69f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6a0:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 6a7:	09 00 00 
    base.s.size = 0;
 6aa:	b8 f8 09 00 00       	mov    $0x9f8,%eax
    base.s.ptr = freep = prevp = &base;
 6af:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 6b6:	09 00 00 
    base.s.size = 0;
 6b9:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 6c0:	00 00 00 
    if(p->s.size >= nunits){
