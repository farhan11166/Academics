...
char buf[32] = "Farhan Alam"; 
  15:	c7 45 d8 46 61 72 68 	movl   $0x68726146,-0x28(%ebp)
printf(1,"Before: %s\n", buf);
  1c:	53                   	push   %ebx
  1d:	68 28 07 00 00       	push   $0x728
  22:	6a 01                	push   $0x1
char buf[32] = "Farhan Alam"; 
  24:	c7 45 dc 61 6e 20 41 	movl   $0x41206e61,-0x24(%ebp)
  2b:	c7 45 e0 6c 61 6d 00 	movl   $0x6d616c,-0x20(%ebp)
  32:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
...
strrev(buf, strlen(buf)); 
  ...
  64:	50                   	push   %eax
  65:	53                   	push   %ebx
  66:	e8 00 03 00 00       	call   36b <strrev>
printf(1, "After: %s\n", buf);
  6b:	83 c4 0c             	add    $0xc,%esp
  6e:	53                   	push   %ebx
  6f:	68 34 07 00 00       	push   $0x734
  74:	6a 01                	push   $0x1
  76:	e8 a5 03 00 00       	call   420 <printf>
exit();
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 3f 07 00 00       	mov    $0x73f,%ebx
