...
80103255:	68 2c 74 10 80       	push   $0x8010742c
...
8010332b:	68 14 74 10 80       	push   $0x80107414
...
801033b6:	68 0f 74 10 80       	push   $0x8010740f
...
801033eb:	68 7c 77 10 80       	push   $0x8010777c
...
80103490:	00 00 00 
  initlock(&p->lock, "pipe");
80103493:	68 31 74 10 80       	push   $0x80107431
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 d5 58 10 80 	movl   $0x801058d5,0x14(%eax)
  p->context = (struct context*)sp;
...
80103945:	68 9c 77 10 80       	push   $0x8010779c
...
80103c70:	e8 fb 2d 00 00       	call   80106a70 <switchuvm>
...
80103c82:	e8 34 0c 00 00       	call   801048bb <swtch>
      switchkvm();
80103c87:	e8 d4 2d 00 00       	call   80106a60 <switchkvm>
      c->proc = 0;
...
80103f79:	e8 a2 2e 00 00       	call   80106e20 <freevm>
        p->pid = 0;
...
801041eb:	68 8f 76 10 80       	push   $0x8010768f
...
80104218:	8b 14 85 c0 7a 10 80 	mov    -0x7fef8540(,%eax,4),%edx
      state = "???";
...
80104abc:	8b 14 85 e0 7a 10 80 	mov    -0x7fef8520(,%eax,4),%edx
...
80104ae8:	68 51 75 10 80       	push   $0x80107551
...
80104c34:	68 89 75 10 80       	push   $0x80107589
...
80104c4c:	68 88 75 10 80       	push   $0x80107588
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 89 75 10 80       	push   $0x80107589
...
80105088:	68 88 75 10 80       	push   $0x80107588
...
80105885:	7e 28                	jle    801058af <sys_toupper+0x5f>
80105887:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010588e:	00 
8010588f:	90                   	nop
    int c=(int)str[i];
80105890:	8b 5d f0             	mov    -0x10(%ebp),%ebx
80105893:	01 c3                	add    %eax,%ebx
80105895:	0f be 13             	movsbl (%ebx),%edx
80105898:	89 d1                	mov    %edx,%ecx
    

    if(c-k<=26 && c-k>=0){
8010589a:	83 ea 61             	sub    $0x61,%edx
8010589d:	83 fa 1a             	cmp    $0x1a,%edx
801058a0:	77 05                	ja     801058a7 <sys_toupper+0x57>
      
      c=c-32;
      str[i]=(char)c;
801058a2:	83 e9 20             	sub    $0x20,%ecx
801058a5:	88 0b                	mov    %cl,(%ebx)
  for(int i=0;i<len;i++){
801058a7:	83 c0 01             	add    $0x1,%eax
801058aa:	39 45 f4             	cmp    %eax,-0xc(%ebp)
801058ad:	7f e1                	jg     80105890 <sys_toupper+0x40>
...
801058b1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801058b4:	c9                   	leave
801058b5:	c3                   	ret
  return -1;
801058b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058bb:	eb f4                	jmp    801058b1 <sys_toupper+0x61>
...
801058be:	06                   	push   %es
  pushl %fs
801058bf:	0f a0                	push   %fs
  pushl %gs
801058c1:	0f a8                	push   %gs
  pushal
801058c3:	60                   	pusha
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058c4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058c8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058ca:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058cc:	54                   	push   %esp
  call trap
801058cd:	e8 be 00 00 00       	call   80105990 <trap>
  addl $4, %esp
801058d2:	83 c4 04             	add    $0x4,%esp
...
801058d5:	61                   	popa
  popl %gs
801058d6:	0f a9                	pop    %gs
  popl %fs
801058d8:	0f a1                	pop    %fs
  popl %es
801058da:	07                   	pop    %es
  popl %ds
801058db:	1f                   	pop    %ds
...
80105944:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
8010594a:	e8 71 ea ff ff       	call   801043c0 <initlock>
}
...
801059b4:	ff 24 85 3c 7b 10 80 	jmp    *-0x7fef84c4(,%eax,4)
...
801059d3:	e8 98 df ff ff       	call   80103970 <myproc>
...
801059f6:	e8 75 df ff ff       	call   80103970 <myproc>
...
80105a85:	68 1c 78 10 80       	push   $0x8010781c
...
80105ab4:	0f 85 4b ff ff ff    	jne    80105a05 <trap+0x75>
    yield();
80105aba:	e8 21 e5 ff ff       	call   80103fe0 <yield>
...
80105ad7:	68 c4 77 10 80       	push   $0x801077c4
...
80105b15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b18:	e8 83 ef ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
...
80105b33:	5d                   	pop    %ebp
      exit();
80105b34:	e9 47 e2 ff ff       	jmp    80103d80 <exit>
...
80105ba8:	e8 43 e5 ff ff       	call   801040f0 <wakeup>
      release(&tickslock);
...
80105bd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bd8:	e8 a3 e1 ff ff       	call   80103d80 <exit>
...
80105bf3:	68 e8 77 10 80       	push   $0x801077e8
...
80105da7:	6a 00                	push   $0x0
  jmp alltraps
80105da9:	e9 0f fb ff ff       	jmp    801058bd <alltraps>
...
80105db0:	6a 01                	push   $0x1
  jmp alltraps
80105db2:	e9 06 fb ff ff       	jmp    801058bd <alltraps>
...
80105db9:	6a 02                	push   $0x2
  jmp alltraps
80105dbb:	e9 fd fa ff ff       	jmp    801058bd <alltraps>
...
80105dc2:	6a 03                	push   $0x3
  jmp alltraps
80105dc4:	e9 f4 fa ff ff       	jmp    801058bd <alltraps>
...
80105dcb:	6a 04                	push   $0x4
  jmp alltraps
80105dcd:	e9 eb fa ff ff       	jmp    801058bd <alltraps>
...
80105dd4:	6a 05                	push   $0x5
  jmp alltraps
80105dd6:	e9 e2 fa ff ff       	jmp    801058bd <alltraps>
...
80105ddd:	6a 06                	push   $0x6
  jmp alltraps
80105ddf:	e9 d9 fa ff ff       	jmp    801058bd <alltraps>
...
80105de6:	6a 07                	push   $0x7
  jmp alltraps
80105de8:	e9 d0 fa ff ff       	jmp    801058bd <alltraps>
...
80105ded:	6a 08                	push   $0x8
  jmp alltraps
80105def:	e9 c9 fa ff ff       	jmp    801058bd <alltraps>
...
80105df6:	6a 09                	push   $0x9
  jmp alltraps
80105df8:	e9 c0 fa ff ff       	jmp    801058bd <alltraps>
...
80105dfd:	6a 0a                	push   $0xa
  jmp alltraps
80105dff:	e9 b9 fa ff ff       	jmp    801058bd <alltraps>
...
80105e04:	6a 0b                	push   $0xb
  jmp alltraps
80105e06:	e9 b2 fa ff ff       	jmp    801058bd <alltraps>
...
80105e0b:	6a 0c                	push   $0xc
  jmp alltraps
80105e0d:	e9 ab fa ff ff       	jmp    801058bd <alltraps>
...
80105e12:	6a 0d                	push   $0xd
  jmp alltraps
80105e14:	e9 a4 fa ff ff       	jmp    801058bd <alltraps>
...
80105e19:	6a 0e                	push   $0xe
  jmp alltraps
80105e1b:	e9 9d fa ff ff       	jmp    801058bd <alltraps>
...
80105e22:	6a 0f                	push   $0xf
  jmp alltraps
80105e24:	e9 94 fa ff ff       	jmp    801058bd <alltraps>
...
80105e2b:	6a 10                	push   $0x10
  jmp alltraps
80105e2d:	e9 8b fa ff ff       	jmp    801058bd <alltraps>
...
80105e32:	6a 11                	push   $0x11
  jmp alltraps
80105e34:	e9 84 fa ff ff       	jmp    801058bd <alltraps>
...
80105e3b:	6a 12                	push   $0x12
  jmp alltraps
80105e3d:	e9 7b fa ff ff       	jmp    801058bd <alltraps>
...
80105e44:	6a 13                	push   $0x13
  jmp alltraps
80105e46:	e9 72 fa ff ff       	jmp    801058bd <alltraps>
...
80105e4d:	6a 14                	push   $0x14
  jmp alltraps
80105e4f:	e9 69 fa ff ff       	jmp    801058bd <alltraps>
...
80105e56:	6a 15                	push   $0x15
  jmp alltraps
80105e58:	e9 60 fa ff ff       	jmp    801058bd <alltraps>
...
80105e5f:	6a 16                	push   $0x16
  jmp alltraps
80105e61:	e9 57 fa ff ff       	jmp    801058bd <alltraps>
...
80105e68:	6a 17                	push   $0x17
  jmp alltraps
80105e6a:	e9 4e fa ff ff       	jmp    801058bd <alltraps>
...
80105e71:	6a 18                	push   $0x18
  jmp alltraps
80105e73:	e9 45 fa ff ff       	jmp    801058bd <alltraps>
...
80105e7a:	6a 19                	push   $0x19
  jmp alltraps
80105e7c:	e9 3c fa ff ff       	jmp    801058bd <alltraps>
...
80105e83:	6a 1a                	push   $0x1a
  jmp alltraps
80105e85:	e9 33 fa ff ff       	jmp    801058bd <alltraps>
...
80105e8c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e8e:	e9 2a fa ff ff       	jmp    801058bd <alltraps>
...
80105e95:	6a 1c                	push   $0x1c
  jmp alltraps
80105e97:	e9 21 fa ff ff       	jmp    801058bd <alltraps>
...
80105e9e:	6a 1d                	push   $0x1d
  jmp alltraps
80105ea0:	e9 18 fa ff ff       	jmp    801058bd <alltraps>
...
80105ea7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ea9:	e9 0f fa ff ff       	jmp    801058bd <alltraps>
...
80105eb0:	6a 1f                	push   $0x1f
  jmp alltraps
80105eb2:	e9 06 fa ff ff       	jmp    801058bd <alltraps>
...
80105eb9:	6a 20                	push   $0x20
  jmp alltraps
80105ebb:	e9 fd f9 ff ff       	jmp    801058bd <alltraps>
...
80105ec2:	6a 21                	push   $0x21
  jmp alltraps
80105ec4:	e9 f4 f9 ff ff       	jmp    801058bd <alltraps>
...
80105ecb:	6a 22                	push   $0x22
  jmp alltraps
80105ecd:	e9 eb f9 ff ff       	jmp    801058bd <alltraps>
...
80105ed4:	6a 23                	push   $0x23
  jmp alltraps
80105ed6:	e9 e2 f9 ff ff       	jmp    801058bd <alltraps>
...
80105edd:	6a 24                	push   $0x24
  jmp alltraps
80105edf:	e9 d9 f9 ff ff       	jmp    801058bd <alltraps>
...
80105ee6:	6a 25                	push   $0x25
  jmp alltraps
80105ee8:	e9 d0 f9 ff ff       	jmp    801058bd <alltraps>
...
80105eef:	6a 26                	push   $0x26
  jmp alltraps
80105ef1:	e9 c7 f9 ff ff       	jmp    801058bd <alltraps>
...
80105ef8:	6a 27                	push   $0x27
  jmp alltraps
80105efa:	e9 be f9 ff ff       	jmp    801058bd <alltraps>
...
80105f01:	6a 28                	push   $0x28
  jmp alltraps
80105f03:	e9 b5 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f0a:	6a 29                	push   $0x29
  jmp alltraps
80105f0c:	e9 ac f9 ff ff       	jmp    801058bd <alltraps>
...
80105f13:	6a 2a                	push   $0x2a
  jmp alltraps
80105f15:	e9 a3 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f1c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f1e:	e9 9a f9 ff ff       	jmp    801058bd <alltraps>
...
80105f25:	6a 2c                	push   $0x2c
  jmp alltraps
80105f27:	e9 91 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f2e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f30:	e9 88 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f37:	6a 2e                	push   $0x2e
  jmp alltraps
80105f39:	e9 7f f9 ff ff       	jmp    801058bd <alltraps>
...
80105f40:	6a 2f                	push   $0x2f
  jmp alltraps
80105f42:	e9 76 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f49:	6a 30                	push   $0x30
  jmp alltraps
80105f4b:	e9 6d f9 ff ff       	jmp    801058bd <alltraps>
...
80105f52:	6a 31                	push   $0x31
  jmp alltraps
80105f54:	e9 64 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f5b:	6a 32                	push   $0x32
  jmp alltraps
80105f5d:	e9 5b f9 ff ff       	jmp    801058bd <alltraps>
...
80105f64:	6a 33                	push   $0x33
  jmp alltraps
80105f66:	e9 52 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f6d:	6a 34                	push   $0x34
  jmp alltraps
80105f6f:	e9 49 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f76:	6a 35                	push   $0x35
  jmp alltraps
80105f78:	e9 40 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f7f:	6a 36                	push   $0x36
  jmp alltraps
80105f81:	e9 37 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f88:	6a 37                	push   $0x37
  jmp alltraps
80105f8a:	e9 2e f9 ff ff       	jmp    801058bd <alltraps>
...
80105f91:	6a 38                	push   $0x38
  jmp alltraps
80105f93:	e9 25 f9 ff ff       	jmp    801058bd <alltraps>
...
80105f9a:	6a 39                	push   $0x39
  jmp alltraps
80105f9c:	e9 1c f9 ff ff       	jmp    801058bd <alltraps>
...
80105fa3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fa5:	e9 13 f9 ff ff       	jmp    801058bd <alltraps>
...
80105fac:	6a 3b                	push   $0x3b
  jmp alltraps
80105fae:	e9 0a f9 ff ff       	jmp    801058bd <alltraps>
...
80105fb5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fb7:	e9 01 f9 ff ff       	jmp    801058bd <alltraps>
...
80105fbe:	6a 3d                	push   $0x3d
  jmp alltraps
80105fc0:	e9 f8 f8 ff ff       	jmp    801058bd <alltraps>
...
80105fc7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fc9:	e9 ef f8 ff ff       	jmp    801058bd <alltraps>
...
80105fd0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fd2:	e9 e6 f8 ff ff       	jmp    801058bd <alltraps>
...
80105fd9:	6a 40                	push   $0x40
  jmp alltraps
80105fdb:	e9 dd f8 ff ff       	jmp    801058bd <alltraps>
...
80105fe2:	6a 41                	push   $0x41
  jmp alltraps
80105fe4:	e9 d4 f8 ff ff       	jmp    801058bd <alltraps>
...
80105feb:	6a 42                	push   $0x42
  jmp alltraps
80105fed:	e9 cb f8 ff ff       	jmp    801058bd <alltraps>
...
80105ff4:	6a 43                	push   $0x43
  jmp alltraps
80105ff6:	e9 c2 f8 ff ff       	jmp    801058bd <alltraps>
...
80105ffd:	6a 44                	push   $0x44
  jmp alltraps
80105fff:	e9 b9 f8 ff ff       	jmp    801058bd <alltraps>
...
80106006:	6a 45                	push   $0x45
  jmp alltraps
80106008:	e9 b0 f8 ff ff       	jmp    801058bd <alltraps>
...
8010600f:	6a 46                	push   $0x46
  jmp alltraps
80106011:	e9 a7 f8 ff ff       	jmp    801058bd <alltraps>
...
80106018:	6a 47                	push   $0x47
  jmp alltraps
8010601a:	e9 9e f8 ff ff       	jmp    801058bd <alltraps>
...
80106021:	6a 48                	push   $0x48
  jmp alltraps
80106023:	e9 95 f8 ff ff       	jmp    801058bd <alltraps>
...
8010602a:	6a 49                	push   $0x49
  jmp alltraps
8010602c:	e9 8c f8 ff ff       	jmp    801058bd <alltraps>
...
80106033:	6a 4a                	push   $0x4a
  jmp alltraps
80106035:	e9 83 f8 ff ff       	jmp    801058bd <alltraps>
...
8010603c:	6a 4b                	push   $0x4b
  jmp alltraps
8010603e:	e9 7a f8 ff ff       	jmp    801058bd <alltraps>
...
80106045:	6a 4c                	push   $0x4c
  jmp alltraps
80106047:	e9 71 f8 ff ff       	jmp    801058bd <alltraps>
...
8010604e:	6a 4d                	push   $0x4d
  jmp alltraps
80106050:	e9 68 f8 ff ff       	jmp    801058bd <alltraps>
...
80106057:	6a 4e                	push   $0x4e
  jmp alltraps
80106059:	e9 5f f8 ff ff       	jmp    801058bd <alltraps>
...
80106060:	6a 4f                	push   $0x4f
  jmp alltraps
80106062:	e9 56 f8 ff ff       	jmp    801058bd <alltraps>
...
80106069:	6a 50                	push   $0x50
  jmp alltraps
8010606b:	e9 4d f8 ff ff       	jmp    801058bd <alltraps>
...
80106072:	6a 51                	push   $0x51
  jmp alltraps
80106074:	e9 44 f8 ff ff       	jmp    801058bd <alltraps>
...
8010607b:	6a 52                	push   $0x52
  jmp alltraps
8010607d:	e9 3b f8 ff ff       	jmp    801058bd <alltraps>
...
80106084:	6a 53                	push   $0x53
  jmp alltraps
80106086:	e9 32 f8 ff ff       	jmp    801058bd <alltraps>
...
8010608d:	6a 54                	push   $0x54
  jmp alltraps
8010608f:	e9 29 f8 ff ff       	jmp    801058bd <alltraps>
...
80106096:	6a 55                	push   $0x55
  jmp alltraps
80106098:	e9 20 f8 ff ff       	jmp    801058bd <alltraps>
...
8010609f:	6a 56                	push   $0x56
  jmp alltraps
801060a1:	e9 17 f8 ff ff       	jmp    801058bd <alltraps>
...
801060a8:	6a 57                	push   $0x57
  jmp alltraps
801060aa:	e9 0e f8 ff ff       	jmp    801058bd <alltraps>
...
801060b1:	6a 58                	push   $0x58
  jmp alltraps
801060b3:	e9 05 f8 ff ff       	jmp    801058bd <alltraps>
...
801060ba:	6a 59                	push   $0x59
  jmp alltraps
801060bc:	e9 fc f7 ff ff       	jmp    801058bd <alltraps>
...
801060c3:	6a 5a                	push   $0x5a
  jmp alltraps
801060c5:	e9 f3 f7 ff ff       	jmp    801058bd <alltraps>
...
801060cc:	6a 5b                	push   $0x5b
  jmp alltraps
801060ce:	e9 ea f7 ff ff       	jmp    801058bd <alltraps>
...
801060d5:	6a 5c                	push   $0x5c
  jmp alltraps
801060d7:	e9 e1 f7 ff ff       	jmp    801058bd <alltraps>
...
801060de:	6a 5d                	push   $0x5d
  jmp alltraps
801060e0:	e9 d8 f7 ff ff       	jmp    801058bd <alltraps>
...
801060e7:	6a 5e                	push   $0x5e
  jmp alltraps
801060e9:	e9 cf f7 ff ff       	jmp    801058bd <alltraps>
...
801060f0:	6a 5f                	push   $0x5f
  jmp alltraps
801060f2:	e9 c6 f7 ff ff       	jmp    801058bd <alltraps>
...
801060f9:	6a 60                	push   $0x60
  jmp alltraps
801060fb:	e9 bd f7 ff ff       	jmp    801058bd <alltraps>
...
80106102:	6a 61                	push   $0x61
  jmp alltraps
80106104:	e9 b4 f7 ff ff       	jmp    801058bd <alltraps>
...
8010610b:	6a 62                	push   $0x62
  jmp alltraps
8010610d:	e9 ab f7 ff ff       	jmp    801058bd <alltraps>
...
80106114:	6a 63                	push   $0x63
  jmp alltraps
80106116:	e9 a2 f7 ff ff       	jmp    801058bd <alltraps>
...
8010611d:	6a 64                	push   $0x64
  jmp alltraps
8010611f:	e9 99 f7 ff ff       	jmp    801058bd <alltraps>
...
80106126:	6a 65                	push   $0x65
  jmp alltraps
80106128:	e9 90 f7 ff ff       	jmp    801058bd <alltraps>
...
8010612f:	6a 66                	push   $0x66
  jmp alltraps
80106131:	e9 87 f7 ff ff       	jmp    801058bd <alltraps>
...
80106138:	6a 67                	push   $0x67
  jmp alltraps
8010613a:	e9 7e f7 ff ff       	jmp    801058bd <alltraps>
...
80106141:	6a 68                	push   $0x68
  jmp alltraps
80106143:	e9 75 f7 ff ff       	jmp    801058bd <alltraps>
...
8010614a:	6a 69                	push   $0x69
  jmp alltraps
8010614c:	e9 6c f7 ff ff       	jmp    801058bd <alltraps>
...
80106153:	6a 6a                	push   $0x6a
  jmp alltraps
80106155:	e9 63 f7 ff ff       	jmp    801058bd <alltraps>
...
8010615c:	6a 6b                	push   $0x6b
  jmp alltraps
8010615e:	e9 5a f7 ff ff       	jmp    801058bd <alltraps>
...
80106165:	6a 6c                	push   $0x6c
  jmp alltraps
80106167:	e9 51 f7 ff ff       	jmp    801058bd <alltraps>
...
8010616e:	6a 6d                	push   $0x6d
  jmp alltraps
80106170:	e9 48 f7 ff ff       	jmp    801058bd <alltraps>
...
80106177:	6a 6e                	push   $0x6e
  jmp alltraps
80106179:	e9 3f f7 ff ff       	jmp    801058bd <alltraps>
...
80106180:	6a 6f                	push   $0x6f
  jmp alltraps
80106182:	e9 36 f7 ff ff       	jmp    801058bd <alltraps>
...
80106189:	6a 70                	push   $0x70
  jmp alltraps
8010618b:	e9 2d f7 ff ff       	jmp    801058bd <alltraps>
...
80106192:	6a 71                	push   $0x71
  jmp alltraps
80106194:	e9 24 f7 ff ff       	jmp    801058bd <alltraps>
...
8010619b:	6a 72                	push   $0x72
  jmp alltraps
8010619d:	e9 1b f7 ff ff       	jmp    801058bd <alltraps>
...
801061a4:	6a 73                	push   $0x73
  jmp alltraps
801061a6:	e9 12 f7 ff ff       	jmp    801058bd <alltraps>
...
801061ad:	6a 74                	push   $0x74
  jmp alltraps
801061af:	e9 09 f7 ff ff       	jmp    801058bd <alltraps>
...
801061b6:	6a 75                	push   $0x75
  jmp alltraps
801061b8:	e9 00 f7 ff ff       	jmp    801058bd <alltraps>
...
801061bf:	6a 76                	push   $0x76
  jmp alltraps
801061c1:	e9 f7 f6 ff ff       	jmp    801058bd <alltraps>
...
801061c8:	6a 77                	push   $0x77
  jmp alltraps
801061ca:	e9 ee f6 ff ff       	jmp    801058bd <alltraps>
...
801061d1:	6a 78                	push   $0x78
  jmp alltraps
801061d3:	e9 e5 f6 ff ff       	jmp    801058bd <alltraps>
...
801061da:	6a 79                	push   $0x79
  jmp alltraps
801061dc:	e9 dc f6 ff ff       	jmp    801058bd <alltraps>
...
801061e3:	6a 7a                	push   $0x7a
  jmp alltraps
801061e5:	e9 d3 f6 ff ff       	jmp    801058bd <alltraps>
...
801061ec:	6a 7b                	push   $0x7b
  jmp alltraps
801061ee:	e9 ca f6 ff ff       	jmp    801058bd <alltraps>
...
801061f5:	6a 7c                	push   $0x7c
  jmp alltraps
801061f7:	e9 c1 f6 ff ff       	jmp    801058bd <alltraps>
...
801061fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106200:	e9 b8 f6 ff ff       	jmp    801058bd <alltraps>
...
80106207:	6a 7e                	push   $0x7e
  jmp alltraps
80106209:	e9 af f6 ff ff       	jmp    801058bd <alltraps>
...
80106210:	6a 7f                	push   $0x7f
  jmp alltraps
80106212:	e9 a6 f6 ff ff       	jmp    801058bd <alltraps>
...
80106219:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010621e:	e9 9a f6 ff ff       	jmp    801058bd <alltraps>
...
80106225:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010622a:	e9 8e f6 ff ff       	jmp    801058bd <alltraps>
...
80106231:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106236:	e9 82 f6 ff ff       	jmp    801058bd <alltraps>
...
8010623d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106242:	e9 76 f6 ff ff       	jmp    801058bd <alltraps>
...
80106249:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010624e:	e9 6a f6 ff ff       	jmp    801058bd <alltraps>
...
80106255:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010625a:	e9 5e f6 ff ff       	jmp    801058bd <alltraps>
...
80106261:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106266:	e9 52 f6 ff ff       	jmp    801058bd <alltraps>
...
8010626d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106272:	e9 46 f6 ff ff       	jmp    801058bd <alltraps>
...
80106279:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010627e:	e9 3a f6 ff ff       	jmp    801058bd <alltraps>
...
80106285:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010628a:	e9 2e f6 ff ff       	jmp    801058bd <alltraps>
...
80106291:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106296:	e9 22 f6 ff ff       	jmp    801058bd <alltraps>
...
8010629d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062a2:	e9 16 f6 ff ff       	jmp    801058bd <alltraps>
...
801062a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062ae:	e9 0a f6 ff ff       	jmp    801058bd <alltraps>
...
801062b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ba:	e9 fe f5 ff ff       	jmp    801058bd <alltraps>
...
801062c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062c6:	e9 f2 f5 ff ff       	jmp    801058bd <alltraps>
...
801062cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062d2:	e9 e6 f5 ff ff       	jmp    801058bd <alltraps>
...
801062d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062de:	e9 da f5 ff ff       	jmp    801058bd <alltraps>
...
801062e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ea:	e9 ce f5 ff ff       	jmp    801058bd <alltraps>
...
801062f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062f6:	e9 c2 f5 ff ff       	jmp    801058bd <alltraps>
...
801062fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106302:	e9 b6 f5 ff ff       	jmp    801058bd <alltraps>
...
80106309:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010630e:	e9 aa f5 ff ff       	jmp    801058bd <alltraps>
...
80106315:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010631a:	e9 9e f5 ff ff       	jmp    801058bd <alltraps>
...
80106321:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106326:	e9 92 f5 ff ff       	jmp    801058bd <alltraps>
...
8010632d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106332:	e9 86 f5 ff ff       	jmp    801058bd <alltraps>
...
80106339:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010633e:	e9 7a f5 ff ff       	jmp    801058bd <alltraps>
...
80106345:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010634a:	e9 6e f5 ff ff       	jmp    801058bd <alltraps>
...
80106351:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106356:	e9 62 f5 ff ff       	jmp    801058bd <alltraps>
...
8010635d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106362:	e9 56 f5 ff ff       	jmp    801058bd <alltraps>
...
80106369:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010636e:	e9 4a f5 ff ff       	jmp    801058bd <alltraps>
...
80106375:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010637a:	e9 3e f5 ff ff       	jmp    801058bd <alltraps>
...
80106381:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106386:	e9 32 f5 ff ff       	jmp    801058bd <alltraps>
...
8010638d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106392:	e9 26 f5 ff ff       	jmp    801058bd <alltraps>
...
80106399:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010639e:	e9 1a f5 ff ff       	jmp    801058bd <alltraps>
...
801063a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063aa:	e9 0e f5 ff ff       	jmp    801058bd <alltraps>
...
801063b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063b6:	e9 02 f5 ff ff       	jmp    801058bd <alltraps>
...
801063bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063c2:	e9 f6 f4 ff ff       	jmp    801058bd <alltraps>
...
801063c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ce:	e9 ea f4 ff ff       	jmp    801058bd <alltraps>
...
801063d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063da:	e9 de f4 ff ff       	jmp    801058bd <alltraps>
...
801063e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063e6:	e9 d2 f4 ff ff       	jmp    801058bd <alltraps>
...
801063ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063f2:	e9 c6 f4 ff ff       	jmp    801058bd <alltraps>
...
801063f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063fe:	e9 ba f4 ff ff       	jmp    801058bd <alltraps>
...
80106405:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010640a:	e9 ae f4 ff ff       	jmp    801058bd <alltraps>
...
80106411:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106416:	e9 a2 f4 ff ff       	jmp    801058bd <alltraps>
...
8010641d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106422:	e9 96 f4 ff ff       	jmp    801058bd <alltraps>
...
80106429:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010642e:	e9 8a f4 ff ff       	jmp    801058bd <alltraps>
...
80106435:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010643a:	e9 7e f4 ff ff       	jmp    801058bd <alltraps>
...
80106441:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106446:	e9 72 f4 ff ff       	jmp    801058bd <alltraps>
...
8010644d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106452:	e9 66 f4 ff ff       	jmp    801058bd <alltraps>
...
80106459:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010645e:	e9 5a f4 ff ff       	jmp    801058bd <alltraps>
...
80106465:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010646a:	e9 4e f4 ff ff       	jmp    801058bd <alltraps>
...
80106471:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106476:	e9 42 f4 ff ff       	jmp    801058bd <alltraps>
...
8010647d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106482:	e9 36 f4 ff ff       	jmp    801058bd <alltraps>
...
80106489:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010648e:	e9 2a f4 ff ff       	jmp    801058bd <alltraps>
...
80106495:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010649a:	e9 1e f4 ff ff       	jmp    801058bd <alltraps>
...
801064a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064a6:	e9 12 f4 ff ff       	jmp    801058bd <alltraps>
...
801064ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064b2:	e9 06 f4 ff ff       	jmp    801058bd <alltraps>
...
801064b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064be:	e9 fa f3 ff ff       	jmp    801058bd <alltraps>
...
801064c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ca:	e9 ee f3 ff ff       	jmp    801058bd <alltraps>
...
801064d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064d6:	e9 e2 f3 ff ff       	jmp    801058bd <alltraps>
...
801064dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064e2:	e9 d6 f3 ff ff       	jmp    801058bd <alltraps>
...
801064e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ee:	e9 ca f3 ff ff       	jmp    801058bd <alltraps>
...
801064f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064fa:	e9 be f3 ff ff       	jmp    801058bd <alltraps>
...
80106501:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106506:	e9 b2 f3 ff ff       	jmp    801058bd <alltraps>
...
8010650d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106512:	e9 a6 f3 ff ff       	jmp    801058bd <alltraps>
...
80106519:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010651e:	e9 9a f3 ff ff       	jmp    801058bd <alltraps>
...
80106525:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010652a:	e9 8e f3 ff ff       	jmp    801058bd <alltraps>
...
80106531:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106536:	e9 82 f3 ff ff       	jmp    801058bd <alltraps>
...
8010653d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106542:	e9 76 f3 ff ff       	jmp    801058bd <alltraps>
...
80106549:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010654e:	e9 6a f3 ff ff       	jmp    801058bd <alltraps>
...
80106555:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010655a:	e9 5e f3 ff ff       	jmp    801058bd <alltraps>
...
80106561:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106566:	e9 52 f3 ff ff       	jmp    801058bd <alltraps>
...
8010656d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106572:	e9 46 f3 ff ff       	jmp    801058bd <alltraps>
...
80106579:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010657e:	e9 3a f3 ff ff       	jmp    801058bd <alltraps>
...
80106585:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010658a:	e9 2e f3 ff ff       	jmp    801058bd <alltraps>
...
80106591:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106596:	e9 22 f3 ff ff       	jmp    801058bd <alltraps>
...
8010659d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065a2:	e9 16 f3 ff ff       	jmp    801058bd <alltraps>
...
801065a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065ae:	e9 0a f3 ff ff       	jmp    801058bd <alltraps>
...
801065b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ba:	e9 fe f2 ff ff       	jmp    801058bd <alltraps>
...
801065c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065c6:	e9 f2 f2 ff ff       	jmp    801058bd <alltraps>
...
801065cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065d2:	e9 e6 f2 ff ff       	jmp    801058bd <alltraps>
...
801065d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065de:	e9 da f2 ff ff       	jmp    801058bd <alltraps>
...
801065e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ea:	e9 ce f2 ff ff       	jmp    801058bd <alltraps>
...
801065f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065f6:	e9 c2 f2 ff ff       	jmp    801058bd <alltraps>
...
801065fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106602:	e9 b6 f2 ff ff       	jmp    801058bd <alltraps>
...
80106609:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010660e:	e9 aa f2 ff ff       	jmp    801058bd <alltraps>
...
80106615:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010661a:	e9 9e f2 ff ff       	jmp    801058bd <alltraps>
...
80106621:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106626:	e9 92 f2 ff ff       	jmp    801058bd <alltraps>
...
8010662d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106632:	e9 86 f2 ff ff       	jmp    801058bd <alltraps>
...
80106639:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010663e:	e9 7a f2 ff ff       	jmp    801058bd <alltraps>
...
80106645:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010664a:	e9 6e f2 ff ff       	jmp    801058bd <alltraps>
...
80106651:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106656:	e9 62 f2 ff ff       	jmp    801058bd <alltraps>
...
8010665d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106662:	e9 56 f2 ff ff       	jmp    801058bd <alltraps>
...
80106669:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010666e:	e9 4a f2 ff ff       	jmp    801058bd <alltraps>
...
80106675:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010667a:	e9 3e f2 ff ff       	jmp    801058bd <alltraps>
...
80106681:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106686:	e9 32 f2 ff ff       	jmp    801058bd <alltraps>
...
8010668d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106692:	e9 26 f2 ff ff       	jmp    801058bd <alltraps>
...
80106699:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010669e:	e9 1a f2 ff ff       	jmp    801058bd <alltraps>
...
801066a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066aa:	e9 0e f2 ff ff       	jmp    801058bd <alltraps>
...
801066b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066b6:	e9 02 f2 ff ff       	jmp    801058bd <alltraps>
...
801066bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066c2:	e9 f6 f1 ff ff       	jmp    801058bd <alltraps>
...
801066c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ce:	e9 ea f1 ff ff       	jmp    801058bd <alltraps>
...
801066d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066da:	e9 de f1 ff ff       	jmp    801058bd <alltraps>
...
801066e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066e6:	e9 d2 f1 ff ff       	jmp    801058bd <alltraps>
...
801066ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066f2:	e9 c6 f1 ff ff       	jmp    801058bd <alltraps>
...
801066f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066fe:	e9 ba f1 ff ff       	jmp    801058bd <alltraps>
...
80106705:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010670a:	e9 ae f1 ff ff       	jmp    801058bd <alltraps>
...
80106711:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106716:	e9 a2 f1 ff ff       	jmp    801058bd <alltraps>
...
8010671d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106722:	e9 96 f1 ff ff       	jmp    801058bd <alltraps>
...
80106729:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010672e:	e9 8a f1 ff ff       	jmp    801058bd <alltraps>
...
80106735:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010673a:	e9 7e f1 ff ff       	jmp    801058bd <alltraps>
...
80106741:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106746:	e9 72 f1 ff ff       	jmp    801058bd <alltraps>
...
8010674d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106752:	e9 66 f1 ff ff       	jmp    801058bd <alltraps>
...
80106759:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010675e:	e9 5a f1 ff ff       	jmp    801058bd <alltraps>
...
80106765:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010676a:	e9 4e f1 ff ff       	jmp    801058bd <alltraps>
...
80106771:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106776:	e9 42 f1 ff ff       	jmp    801058bd <alltraps>
...
8010677d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106782:	e9 36 f1 ff ff       	jmp    801058bd <alltraps>
...
80106789:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010678e:	e9 2a f1 ff ff       	jmp    801058bd <alltraps>
...
80106795:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010679a:	e9 1e f1 ff ff       	jmp    801058bd <alltraps>
...
801067a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067a6:	e9 12 f1 ff ff       	jmp    801058bd <alltraps>
...
801067ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067b2:	e9 06 f1 ff ff       	jmp    801058bd <alltraps>
...
801067b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067be:	e9 fa f0 ff ff       	jmp    801058bd <alltraps>
...
801067c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ca:	e9 ee f0 ff ff       	jmp    801058bd <alltraps>
...
801067d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067d6:	e9 e2 f0 ff ff       	jmp    801058bd <alltraps>
...
801067dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067e2:	e9 d6 f0 ff ff       	jmp    801058bd <alltraps>
...
801067e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ee:	e9 ca f0 ff ff       	jmp    801058bd <alltraps>
...
801067f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067fa:	e9 be f0 ff ff       	jmp    801058bd <alltraps>
...
80106801:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106806:	e9 b2 f0 ff ff       	jmp    801058bd <alltraps>
...
8010680d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106812:	e9 a6 f0 ff ff       	jmp    801058bd <alltraps>
...
80106977:	e8 34 dd ff ff       	call   801046b0 <memset>
...
80106a94:	0f 84 c2 00 00 00    	je     80106b5c <switchuvm+0xec>
  pushcli();
80106a9a:	e8 c1 d9 ff ff       	call   80104460 <pushcli>
...
80106b49:	5d                   	pop    %ebp
  popcli();
80106b4a:	e9 61 d9 ff ff       	jmp    801044b0 <popcli>
...
80106baf:	e8 fc da ff ff       	call   801046b0 <memset>
...
80106be0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106be1:	e9 5a db ff ff       	jmp    80104740 <memmove>
...
80106cc0:	68 60 78 10 80       	push   $0x80107860
...
80106d1b:	e8 90 d9 ff ff       	call   801046b0 <memset>
...
80107030:	e8 0b d7 ff ff       	call   80104740 <memmove>
...
80107160:	e8 db d5 ff ff       	call   80104740 <memmove>
    len -= n;
    buf += n;
